...
// export const useAnnonymouseVerifi = (
//     target: VerificationTarget,
//     _extraInfo?: StoreSignInAnonymousCompleteExtraInfoInput
// ) => {
//     const [code, setCode] = useState("");
//     const [verifiData, setVerifiData] =
//         useState<verificationComplete_VerificationComplete_data>();

//     const [verifiAnony, { loading: startLoading }] =
//         useStoreSignInAnonymousStart({
//             onCompleted: ({ StoreSignInAnonymousStart }) => {
//                 if (completeMsg(StoreSignInAnonymousStart, "인증코드 발송"))
//                     setVerifiData(StoreSignInAnonymousStart.data!);
//             },
//         });
//     const [verifiAnonyComplete, { loading: completeLoading }] =
//         useStoreSignInAnonymousComplete({
//             onCompleted: ({ StoreSignInAnonymousComplete }) => {
//                 if (
//                     completeMsg(
//                         StoreSignInAnonymousComplete,
//                         "인증완료",
//                         "인증번호를 다시 확인 해주세요"
//                     )
//                 ) {
...
//                 },
//                 extraInfo: _extraInfo || extraInfo,
//             },
//         }).then((result) => {
