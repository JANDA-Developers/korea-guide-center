...
type TConOrigin = Record<IIcons, (prop: HTMLAttributes<SVGElement>) => any>;
...
export const IConOrigin: TConOrigin = {
    ...
    line: (props) => (
        <BasicIcon
            {...props}
            path={
                "M19 24h-14c-2.761 0-5-2.239-5-5v-14c0-2.761 2.239-5 5-5h14c2.762 0 5 2.239 5 5v14c0 2.761-2.238 5-5 5zm1-12.508c0-3.58-3.589-6.492-8-6.492s-8 2.912-8 6.492c0 3.209 2.846 5.897 6.691 6.405.26.056.615.172.704.395.081.202.053.519.026.723l-.114.685c-.035.202-.161.791.693.431.854-.36 4.607-2.713 6.286-4.645h-.001c1.16-1.271 1.715-2.561 1.715-3.994zm-10.978 2.067h-2.242l-.108-.043v-.001l-.001-.001-.003-.003-.044-.107v-3.486c0-.086.07-.156.156-.156h.562c.085 0 .155.07.155.156v2.768h1.525c.086 0 .155.07.155.156v.561c0 .086-.069.156-.155.156zm8.314 0h-2.242l-.108-.043-.004-.005-.044-.107v-3.486l.044-.107.004-.005.108-.044h2.242c.086 0 .155.07.155.156v.561c0 .086-.069.156-.155.156h-1.525v.589h1.525c.086 0 .155.07.155.156v.561c0 .086-.069.156-.155.156h-1.525v.589h1.525c.086 0 .155.07.155.156v.561c0 .086-.069.156-.155.156zm-6.961 0h-.562c-.086 0-.156-.069-.156-.155v-3.486c0-.086.07-.156.156-.156h.562c.086 0 .155.07.155.156v3.486c0 .085-.069.155-.155.155zm1.418 0h-.561c-.086 0-.156-.069-.156-.155v-3.486c0-.086.07-.156.156-.156h.561l.013.001.015.002.009.002.015.004.005.002.014.006.013.008.008.005.012.01.003.003.01.011.013.015 1.597 2.158v-2.071c0-.086.07-.156.156-.156h.561c.086 0 .156.07.156.156v3.486c0 .085-.07.155-.156.155h-.561l-.04-.005-.002-.001-.016-.005-.007-.003-.012-.006-.01-.006-.001-.001-.04-.039-1.599-2.16v2.071c0 .085-.07.155-.156.155z"
            }
        ></BasicIcon>
    ),
    upload: (props) => (
        <svg viewBox="0 0 24 27.08" {...props}>
            <g id="Layer_2" data-name="Layer 2">
                <g id="Layer_1-2" data-name="Layer 1">
                    <path d="M22.5,24.08H1.5a1.5,1.5,0,0,0,0,3h21a1.5,1.5,0,0,0,0-3Z" />
                    <path d="M13.06.44a1.5,1.5,0,0,0-2.12,0L1.23,10.15a1.47,1.47,0,0,0-.44,1.06,1.46,1.46,0,0,0,.44,1.06,1.53,1.53,0,0,0,2.12,0L10.5,5.12V20.83a1.5,1.5,0,0,0,3,0V5.12l7.15,7.15a1.5,1.5,0,1,0,2.12-2.12Z" />
                </g>
            </g>
        </svg>
    ),
    ...
    roundHeart: (props) => (
        <BasicIcon
            {...props}
            viewBox={"0 0 18.9 16.7"}
            path={
                "M9.5,4.7c0.3-2.2,2.1-3.9,4.4-3.9c0.1,0,0.1,0,0.2,0c2.3,0.1,4.2,1.9,4.3,4.3c0,0.1,0,0.1,0,0.2  c0,1.1-0.4,2.1-1,2.8l-0.6,0.6l-7.2,7.2L2.3,8.7L1.6,8c-0.6-0.8-1-1.7-1-2.8c0-0.1,0-0.1,0-0.2c0.1-2.3,2-4.2,4.3-4.3  c0.1,0,0.1,0,0.2,0C7.3,0.8,9.2,2.5,9.5,4.7L9.5,4.7z"
            }
        />
    ),
    flag: (props) => (
        <BasicIcon
            {...props}
            viewBox={"0 0 29.9 34.4"}
            path={
                "M20.6,10.5l7.6-6.5c0.5-0.4,0.6-1.1,0.4-1.7c-0.2-0.6-0.8-1-1.4-1H2.6C1.8,1.3,1.1,2,1.1,2.8s0.7,1.5,1.5,1.5  h20.5l-5.8,4.9c-0.3,0.3-0.5,0.7-0.5,1.1c0,0.4,0.1,0.8,0.4,1.1l5.8,5.8H4.6V9c0-0.8-0.7-1.5-1.5-1.5S1.6,8.2,1.6,9v22.6  c0,0.8,0.7,1.5,1.5,1.5s1.5-0.7,1.5-1.5V20.3h22.2c0.6,0,1.2-0.4,1.4-0.9s0.1-1.2-0.3-1.6L20.6,10.5z"
            }
        />
    ),
    humanWithNameCard: (props) => (
        <BasicIcon
            fillRule="evenodd"
            clipRule="evenodd"
            {...props}
    ...
    paperPlane: (props) => (
        <BasicIcon
            ...
            {...props}
            path={
                "M0 12l11 3.1 7-8.1-8.156 5.672-4.312-1.202 15.362-7.68-3.974 14.57-3.75-3.339-2.17 2.925v-.769l-2-.56v7.383l4.473-6.031 4.527 4.031 6-22z"
            }
        />
    ),
    circleArrowUp: (props) => (
        <BasicIcon
            ...
            {...props}
            path={
                "M24 12c0 6.623-5.377 12-12 12s-12-5.377-12-12 5.377-12 12-12 12 5.377 12 12zm-1 0c0 6.071-4.929 11-11 11s-11-4.929-11-11 4.929-11 11-11 11 4.929 11 11zm-11.5-4.828l-3.763 4.608-.737-.679 5-6.101 5 6.112-.753.666-3.747-4.604v11.826h-1v-11.828z"
            }
        />
    ),
    circleX: (props) => (
    ...
    circleArrowDown: (props) => (
        <BasicIcon
            fillRule="evenodd"
            clipRule="evenodd"
            {...props}
            path={
                "M24 12c0-6.623-5.377-12-12-12s-12 5.377-12 12 5.377 12 12 12 12-5.377 12-12zm-1 0c0-6.071-4.929-11-11-11s-11 4.929-11 11 4.929 11 11 11 11-4.929 11-11zm-11.5 4.828l-3.763-4.608-.737.679 5 6.101 5-6.112-.753-.666-3.747 4.604v-11.826h-1v11.828z"
            }
        />
    ),
    toogleMenu: (props) => (
        <BasicIcon
            {...props}
            path={
                "M13 6h-13v-4h13v4zm0 4h-13v4h13v-4zm0 8h-13v4h13v-4zm3-8l4 5.075 4-5.075h-8z"
            }
        />
    ),
    travel: (props) => (
    ...
    heart: (props) => (
        <BasicIcon {...props} path={"M18 1l-6 4-6-4-6 5v7l12 10 12-10v-7z"} />
    ),
    heartEmpty: (props) => (
        <BasicIcon
            {...props}
            path={
                "M17.867 3.493l4.133 3.444v5.127l-10 8.333-10-8.334v-5.126l4.133-3.444 5.867 3.911 5.867-3.911zm.133-2.493l-6 4-6-4-6 5v7l12 10 12-10v-7l-6-5z"
            }
        />
    ),
    emptyStar: (prop) => (
        <BasicIcon
            {...prop}
            path="M12 6.76l1.379 4.246h4.465l-3.612 2.625 1.379 4.246-3.611-2.625-3.612 2.625 1.379-4.246-3.612-2.625h4.465l1.38-4.246zm0-6.472l-2.833 8.718h-9.167l7.416 5.389-2.833 8.718 7.417-5.388 7.416 5.388-2.833-8.718 7.417-5.389h-9.167l-2.833-8.718z"
        />
    ),
    fullStar: (prop) => (
        <BasicIcon
            {...prop}
            path="M12 .288l2.833 8.718h9.167l-7.417 5.389 2.833 8.718-7.416-5.388-7.417 5.388 2.833-8.718-7.416-5.389h9.167z"
        />
    ),
    arrowSlim: (props) => (
        <svg
            ...
            viewBox="0 0 14.74 7.89"
        >
            <defs>
                <style
                    dangerouslySetInnerHTML={{
                        __html: ".cls-2{fill:none;stroke:#4d4d4d;stroke-linecap:round;stroke-linejoin:round;}",
                    }}
                />
            </defs>
            <line className="cls-2" x1="0.5" y1="0.5" x2="7.34" y2="7.34" />
            <line className="cls-2" x1="14.24" y1="0.55" x2="7.39" y2="7.39" />
        </svg>
    ),
    interactive: (props) => (
        <svg
            {...props}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 25.87 22"
        >
            <defs>
                <style
                    dangerouslySetInnerHTML={{
                        __html: ".cls-1{fill:none;stroke-linecap:round;stroke-linejoin:round;}",
                    }}
                />
            </defs>
            <polygon
                className="cls-1"
                points="10.52 12.27 10.52 3.14 3.81 3.14 3.81 12.27 1 12.27 7.17 21 13.34 12.27 10.52 12.27"
            />
            <polygon
                className="cls-1"
                points="15.34 9.73 15.34 18.86 22.05 18.86 22.05 9.73 24.87 9.73 18.7 1 12.53 9.73 15.34 9.73"
            />
        </svg>
    ),
    arrows: (props) => (
        <svg
            ...
            y="0px"
            viewBox="0 0 44 25.6"
            enableBackground={"new 0 0 44 25.6"}
            xmlSpace="preserve"
        >
            <style
                type="text/css"
            ...
            <path
                className="st0"
                d="M2.6,24.5c-0.5,0-1-0.2-1.4-0.6c-0.8-0.8-0.8-2,0-2.8l8.5-8.5L1.2,4.1c-0.8-0.8-0.8-2,0-2.8s2-0.8,2.8,0  l9.9,9.9c0.4,0.4,0.6,0.9,0.6,1.4s-0.2,1-0.6,1.4L4,23.9C3.6,24.3,3.1,24.5,2.6,24.5z"
            />
            <path
                className="st0"
                d="M12.1,24.5c-0.5,0-1-0.2-1.4-0.6c-0.8-0.8-0.8-2,0-2.8l8.5-8.5l-8.5-8.5c-0.8-0.8-0.8-2,0-2.8s2-0.8,2.8,0  l9.9,9.9c0.4,0.4,0.6,0.9,0.6,1.4s-0.2,1-0.6,1.4l-9.9,9.9C13.2,24.3,12.6,24.5,12.1,24.5z"
            />
            <path
                className="st0"
                d="M21.7,24.5c-0.5,0-1-0.2-1.4-0.6c-0.8-0.8-0.8-2,0-2.8l8.5-8.5l-8.5-8.5c-0.8-0.8-0.8-2,0-2.8s2-0.8,2.8,0  l9.9,9.9c0.8,0.8,0.8,2,0,2.8l-9.9,9.9C22.7,24.3,22.2,24.5,21.7,24.5z"
            />
            <path
                className="st0"
                d="M31.2,24.5c-0.5,0-1-0.2-1.4-0.6c-0.8-0.8-0.8-2,0-2.8l8.5-8.5l-8.5-8.5c-0.8-0.8-0.8-2,0-2.8s2-0.8,2.8,0  l9.9,9.9c0.8,0.8,0.8,2,0,2.8l-9.9,9.9C32.2,24.3,31.7,24.5,31.2,24.5z"
            />
        </svg>
    ),
    link: (props) => (
        ...
        >
            ...
            <g>
                <path
                    className="st0"
                    d="M24.7,1.8c-2.4-2.4-6.4-2.4-8.9,0l-4.9,4.9c-0.8,0.8-1.4,1.9-1.7,3.1c-0.5,2.1,0.2,4.3,1.7,5.8   c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4c-1-1-1.5-2.5-1.1-3.9c0.2-0.8,0.6-1.5,1.1-2.1l4.9-4.9   c1.7-1.7,4.4-1.7,6,0c1.7,1.7,1.7,4.4,0,6l-4.2,4.2c-0.4,0.4-0.4,1,0,1.4c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3l4.2-4.2   C27.2,8.3,27.2,4.3,24.7,1.8z"
                />
                <path
                    className="st0"
                    d="M15.6,10.9c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4c1,1,1.5,2.5,1.1,3.9c0,0,0,0,0,0c-0.2,0.8-0.6,1.5-1.1,2.1   l-4.9,4.9c-0.8,0.8-1.9,1.3-3,1.3s-2.2-0.4-3-1.3c-0.8-0.8-1.3-1.9-1.3-3c0-1.1,0.4-2.2,1.3-3l4.1-4.1c0.4-0.4,0.4-1,0-1.4   s-1-0.4-1.4,0l-4.1,4.1C0.7,17,0,18.6,0,20.3c0,1.7,0.7,3.3,1.8,4.4s2.8,1.8,4.4,1.8c1.7,0,3.3-0.7,4.4-1.8l4.9-4.9   c0.8-0.8,1.4-1.9,1.7-3.1c0,0,0,0,0,0C17.7,14.6,17.1,12.5,15.6,10.9z"
                />
            </g>
        </svg>
    ),
    newWindow: (prop) => (
        <svg
            ...
            enableBackground="new 0 0 26.4 26.4"
            xmlSpace="preserve"
        >
            <style
                type="text/css"
            ...
            <path
                className="st0"
                d="M25.4,0H6.7c-0.6,0-1,0.4-1,1v4.6H1c-0.6,0-1,0.4-1,1v18.7c0,0.6,0.4,1,1,1h18.7c0.6,0,1-0.4,1-1v-4.6h4.7  c0.6,0,1-0.4,1-1V1C26.4,0.4,26,0,25.4,0z M18.7,24.4H2V7.6h3.7v12.1c0,0.6,0.4,1,1,1h12V24.4z M24.4,18.7h-4.7h-12V6.6V2h16.7V18.7  z"
            />
            <polygon
                className="st0"
                points="19.6,9.3 16.5,9.3 16.5,6.2 14.9,6.2 14.9,9.3 11.8,9.3 11.8,10.9 14.9,10.9 14.9,14 16.5,14   16.5,10.9 19.6,10.9 "
            />
        </svg>
    ),
    shoppingCart: (prop) => (
        <svg {...prop} viewBox="0 0 13.9 12.5">
            <polygon
                style={shoppingCar}
                className="cls-1"
                points="12.3 9.2 4 9.2 2.8 3.4 13.5 3.4 12.3 9.2"
            />
            <circle
                style={shoppingCar}
                className="cls-1"
    ...
    verticalDots: (prop) => (
        <BasicIcon
            {...prop}
            path="M12 18c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3zm0-9c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3zm0-9c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3z"
        />
    ),
    PATH: (prop) => <BasicIcon path="" {...prop} />,
    circleGraphFill: (prop) => (
        <BasicIcon
            {...prop}
            path={
                "M23.949 13c-.509 6.158-5.66 11-11.949 11-6.627 0-12-5.373-12-12 0-6.29 4.842-11.44 11-11.95v12.95h12.949zm-10.949-2h10.949c-.481-5.828-5.122-10.467-10.949-10.95v10.95z"
            }
        />
    ),
    checkCircle: (prop) => (
        <BasicIcon
            {...prop}
            path={
                "M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm4.393 7.5l-5.643 5.784-2.644-2.506-1.856 1.858 4.5 4.364 7.5-7.643-1.857-1.857z"
            }
        />
    ),
    pen: (prop) => (
    ...
    logo: (prop) => (
        ...
        >
            ...
            <g>
                <path
                    className="st0"
                    d="M4,42.5l16.8-15.3c0,0,30.4,31.1,32,72.1h-15C37.8,99.2,35.5,70.5,4,42.5z"
                />
                <path
                    className="st0"
                    d="M53.7,91c0,0,11.7-58,51.8-87.2c0,0-37.9,14.7-59.8,58.4C45.7,62.2,52.8,75.6,53.7,91z"
                />
            </g>
        </svg>
    ),
    sqaureShape: (prop) => (
        <svg {...prop} version="1.1" id="Layer_1" viewBox="0 0 17.9 17">
            <path
                style={commonStyle}
                d="M17.1,4.4H0.8C0.3,4.4,0,4.1,0,3.7V0.8C0,0.3,0.3,0,0.8,0h16.4c0.4,0,0.8,0.3,0.8,0.8v2.9
      C17.9,4.1,17.6,4.4,17.1,4.4z M1.5,2.9h14.9V1.5H1.5V2.9z"
            />
            <path
                style={commonStyle}
                d="M17.1,10.7H0.8C0.3,10.7,0,10.4,0,9.9V7c0-0.4,0.3-0.8,0.8-0.8h16.4c0.4,0,0.8,0.3,0.8,0.8v2.9
      C17.9,10.4,17.6,10.7,17.1,10.7z M1.5,9.2h14.9V7.7H1.5V9.2z"
            />
            <path
                style={commonStyle}
                d="M17.1,17H0.8C0.3,17,0,16.6,0,16.2v-2.9c0-0.4,0.3-0.8,0.8-0.8h16.4c0.4,0,0.8,0.3,0.8,0.8v2.9
    ...
    pay: (prop) => (
        <svg {...prop} viewBox="0 0 28.85 31.5">
            ...
            <polyline
                style={commonStyle}
                points="11.21 5.17 13.42 1.96 9.6 0.75"
            />
            <polyline
                style={commonStyle}
    ...
    info: (prop) => (
        ...
        >
            <defs>
                <style
                    dangerouslySetInnerHTML={{ __html: ".cls-3{fill:#333;}" }}
                />
            </defs>
            <path
                className="cls-3"
                d="M1190.22,355a10.94,10.94,0,1,1,10.94-10.93A10.95,10.95,0,0,1,1190.22,355Zm0-20a9.07,9.07,0,1,0,9.06,9.07A9.07,9.07,0,0,0,1190.22,335Z"
                transform="translate(-1179.28 -333.16)"
            />
            <path
                className="cls-3"
                d="M1193.21,338.39a1.55,1.55,0,1,1-1.54-1.54A1.54,1.54,0,0,1,1193.21,338.39Z"
                transform="translate(-1179.28 -333.16)"
            />
            <path
                className="cls-3"
                d="M1188.28,341.62h4l-2.06,7.71s-.33,1,.56.19c.61-.57,1.83-1.82,1.83-1.82a6,6,0,0,1-1,1.77,3.08,3.08,0,0,1-1.69,1.41c-2,.46-2.38-.24-1.73-2.58s1.73-5.75,1.73-5.75h-1.63Z"
                transform="translate(-1179.28 -333.16)"
            />
        </svg>
    ),
    ...
    jdR: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_4548bd61-1050-4b50-a968-19b28bfcbcad
            </title>
            <path
    ...
    jdT: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_168a468e-44d8-4978-8eed-b213ef305b22
            </title>
            <path
    ...
    jdS: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_1e2bc969-4992-4e76-85a9-74bed51ca0f2
            </title>
            <path
    ...
    jdG: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_30f56b14-d171-44c4-b3c5-c478d6c0d760
            </title>
            <path
    ...
    barGraph: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_f88ca520-c005-4834-b4af-968d2eb9cfa8
            </title>
            <rect
                x="0.75"
                y="0.75"
    ...
    won: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_061ac295-a135-45a1-a6e1-b33bf5ea232f
            </title>
            <line
                x1="2.96"
                y1="0.75"
    ...
    gear: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_63b72998-2b55-435c-ade2-418692017853
            </title>
            <path
    ...
    arrowUp: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_500b885d-fba7-4086-b193-7c90bf75002b
            </title>
            <polygon
    ...
    speechBubble: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_fa2f7063-e023-4b72-a306-23c3232165c5
            </title>
            <path
    ...
    recipt: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_2f1e31e9-b3a6-487b-a5f2-497f3c64b3ed
            </title>
            <path
    ...
    gearBox: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_f36a0836-797f-4c61-a28a-45daed203f40
            </title>
            <path
    ...
    houseGear: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_927f429e-97eb-4d27-bfa3-7d273babd699
            </title>
            <path
    ...
    speechBubble2: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_17054da0-2c9b-4715-b8a3-8eb34b641347
            </title>
            <path
    ...
    triWarn: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_23a64a79-a223-4ba7-8b05-0d993eee2317
            </title>
            <path
    ...
    diffuser: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_88a1c67e-51e6-4ea2-a93d-b484e22ef849
            </title>
            <path
    ...
    exclamation: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_e4390001-4b1d-41f5-8992-e9ea899d9144
            </title>
            <path
    ...
    chair: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_ff49114a-ec2b-4670-b07a-76cce05028ce
            </title>
            <path
    ...
    vim: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_2ec30cfa-dfdc-415e-915a-748a3d56af0b
            </title>
            <path
    ...
    board: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_f6d8565d-c211-40d4-81d4-8638d9a7efed
            </title>
            <path
    ...
    wifi: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_135d3266-ee9b-446f-b84d-caa9db3c8e0f
            </title>
    ...
    arrowRight: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_2502a534-3596-40ba-8d74-806c73987cff
            </title>
            <polygon
    ...
    arrowDown: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_d6052027-5849-4778-bf00-5cef4ec150ae
            </title>
            <polygon
    ...
    bell: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_ed02686d-3918-42e6-aa4d-0822626ca74e
            </title>
            <path
    ...
    share: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_9f970651-4902-439d-988c-ae1555aedb1c
            </title>
            <path
    ...
    trashCan: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_3be31275-23bc-4b5f-a8ed-c6f9966922d8
            </title>
            <path
    ...
    fillStar: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_5988e1f9-9688-4c54-b175-632474c6619a
            </title>
            <path
    ...
    plus: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_3cfc2ab7-99f8-44ed-8d59-fcaa3249f918
            </title>
    ...
    search: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_7edecb23-7d49-4914-9106-933a65f08a5d
            </title>
            <path
    ...
    arrowBack: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_666c0cbd-365f-4ea3-865e-d2986466c7af
            </title>
    ...
    kakaoTalk: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_0266760f-85e6-42c0-bc4f-7edabf18bc76
            </title>
            <path
    ...
    email: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_1fb440f9-eb0e-4d46-968a-4493dbd7143c
            </title>
            <path
    ...
    list: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_49655cad-5fd7-41ae-86eb-f5bf34407ef3
            </title>
            <path
    ...
    question: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_df5e26ff-2472-49ab-acaa-b0458ca2c1d5
            </title>
            <path
    ...
    box: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_f53783eb-83f0-4344-8b31-eafc63377804
            </title>
            <path
    ...
    circleRightArrow: (prop) => (
        ...
        >
            <title>
                VectorSmartObject_8848228b-6b22-46a0-a2a3-e6c39d09abcf
            </title>
            <path
