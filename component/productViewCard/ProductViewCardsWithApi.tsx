...
import { IProductViewCardsProp, ProductViewCards } from "./ProductViewCards";

export interface IProductViewCardsWithApiProps extends Omit<IProductViewCardsProp, "products"> {
...
export const ProductViewCardsWithApi = React.memo<IProductViewCardsWithApiProps>(({
    queryControl,
    queryParam,
    Head,
    ...props
