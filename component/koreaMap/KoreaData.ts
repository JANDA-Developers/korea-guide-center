...
export const regionableData: Record<mapRegion, IRegionableaData> = {
    ...
    NorthGyeongsang: {
        description: {
            ...
            ko: `놀랍게도 서울을 탈출하기로 선택한 여행자 대부분은 경상도로 향합니다. 그중에서도 경상북도는 한국의 전통사상의 유적지가 많은 곳으로, 고대 부족 국가인 bc4~5c의 가야국과 거의 천년 동안 통치한 신라 왕국의 거점이었기 때문에 고대의 고분. 장신구, 토기, 사원은 과거 경이로움에 대한 증거를 현시대에 제공함과 동시에 로컬의 민속적 특징과 체험을 즐길수 있는 곳으로 경상북도를 방문하면 맛있는 찜닭과 함께 매우 인상적인 추억을 간직하게 될 것입니다. `,
        },
        photos: [],
        title: {
            en: `
    ...
    Ulsan: {
        description: {
            ...
            ko: `울산시는 동해바다에 위치한 도시로써 동북아시아에서 가장 먼저 일출을 볼 수 있는 곳으로 신년이면 많은사람들이 일출을 보며 1년의 행운을 기원하며 즐기기 위해 모이는 곳입니다. 동해바다를 바라보며 산책하기 좋으며 5월 태화강 봄꽃 페스티벌을 시작으로 한국 유일의 고래축제, 김치, 고추장등 발효음식을 저장하기 좋은 옹기를 만드는 축제 등 다양한 축제가 여행객을 즐겁게 해주는 곳입니다. `,
        },
        photos: [],
        title: {
            en: `
    ...
    busan: {
        description: {
            ...
            ko: `한국의 가장 남단에 위치하여 한국전쟁때 임시수도였던 부산은 한국 최대의 물류와 교역의 역사깊은 항구도시입니다. 바닷가의 하안선을 따라 고층의 고급맨션과 호텔, 요트, 해변산책로, 맛있는 해산물 요리와 항구도시의 야경 등은 여행자들을 매료시킵니다.`,
        },
        photos: [],
        title: {
            en: `
    ...
    daegu: {
        description: {
            ...
            ko: `경상북도의 중심도시로써 인구 230만의 대도시입니다. 625 한국전쟁 때 한국의 남쪽최후 방어지역으로 북한과 남한의 격전지였으나, 근대시대부터 방적공장이 발달했으며 한국 최대의 섬유 생산지이며 패션의 도시로써 유명합니다. 한국의 대표음식이 된 한국스타일 양념치킨의 탄생지여서 7월의 맥주와 치킨 페스티벌은 여행객들에게 인기입니다. 또한 의료관광의 메카로써 한방/ 피부/ 산부인과 등 웰니스 산업이 발달한 도시로 의료관광 방문객이 많은 곳이기도 합니다.`,
        },
        photos: [],
        title: {
            en: `
    ...
    seoul: {
        description: {
            ...
            ko: `—Brad Japhe(포브스기자) 아시아 관광객들이 정기적으로 한국의 수도 서울을 가장 좋아하는 세계 도시로 꼽는 데에는 이유가 있습니다.
            한국의 정치, 문화, 경제생활의 중심지인 서울은 자랑스러운 과거를 충실히 지키면서 미래를 향해 겁 없이 나아가는 역동적인 도시입니다. 
            세계에서 가장 빠른 인터넷의 본고장이자 아시아에서 가장 오래된 도시 지역 중 하나인 서울에서 한국여행을 시작해 볼까요?`,
        },
        photos: [],
        title: {
            en: `
    ...
    dmz: {
        description: {
            ...
            ko: `비무장지대는 영어로는 DMZ(Demilitarized Zone)라고 표기하며, 휴전선으로부터 남·북으로 각각 2km씩 지정된 곳으로 군사력을 동원해서 병력을 배치하지 않기로 지정하여 중립국 감시단이 비무장으로 잘 유지되고 있는지 감시 활동을 펼치는 곳으로 남,북측 모두 민간인의 출입도 철처하게 통제되고 있으나 북한을 육안으로도 볼 수 있는 곳입니다. 40년 넘도록 사람들의 출입이 통제되었기 때문에 자연이 잘 보존되어 있어 자연생태계 연구의 학술적 대상으로 주목받고 있으며, 한국의 격동의 전쟁의 역사가 현재에도 이어지고 있는 현장이므로 특별출입허가를 받아야 관광을 할 수 있기 때문에 오히려 여행객들에게는 색다른 명소입니다.`,
        },
        photos: [],
        title: {
            en: `
